...
class ProductAdapter(private val productList: List<Product>) :
    ...
    class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val txtName = itemView.findViewById<TextView>(R.id.product_name)
        val txtDesc = itemView.findViewById<TextView>(R.id.product_description)
        val txtPrice = itemView.findViewById<TextView>(R.id.product_cost)
        val imgProduct = itemView.findViewById<ImageView>(R.id.product_photo)
        val btnPurchase = itemView.findViewById<Button>(R.id.purchase)
    }
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        val imageUrl = "https://jobsimba.pythonanywhere.com/static/images/${product.product_photo}"
